  ...
  const nfts: NFT[] = [
    {
      ...
      image: "https://via.placeholder.com/300x300/6366f1/ffffff?text=Marathon+Master",
      rarity: 'rare',
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/300x300/8b5cf6/ffffff?text=Strength+Champion",
      rarity: 'uncommon',
      category: 'achievement',
      unlocked: true,
      tokenId: "2183",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/300x300/10b981/ffffff?text=Weekly+Warrior",
      rarity: 'uncommon',
      category: 'challenge',
      unlocked: true,
      tokenId: "3692",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/300x300/ec4899/ffffff?text=Yoga+Guru",
      rarity: 'common',
      category: 'achievement',
      unlocked: true,
      tokenId: "5827",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/300x300/f59e0b/ffffff?text=Ironman+Legend",
      rarity: 'legendary',
      category: 'challenge',
      unlocked: false,
      attributes: [
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/300x300/ef4444/ffffff?text=90-Day+Streak",
      rarity: 'epic',
      category: 'achievement',
      unlocked: false,
      attributes: [
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/300x300/0ea5e9/ffffff?text=First+Edition",
      rarity: 'legendary',
      category: 'limited',
      unlocked: true,
      tokenId: "0042",
